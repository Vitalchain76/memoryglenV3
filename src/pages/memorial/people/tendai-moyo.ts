...
const data: MemorialData = {
  ...
  gallery: [
    { src: '/tendai-life-1.jpg', caption: 'A gathering of family, everyone together' },
    { src: '/tendai-life-2.jpg', caption: 'A quiet morning at home' },
    { src: '/tendai-life-3.jpg', caption: 'Celebrating a milestone with loved ones' },
    { src: '/tendai-life-4.jpg', caption: 'Sunday best, ready for church' },
    { src: '/tendai-life-5.jpg', caption: 'Among friends and neighbours' },
    { src: '/tendai-life-6.jpg', caption: 'A treasured everyday moment' },
  ],
  ...
  candles: 86,
  providers: [
    { name: 'Eternal Stone Tombstones', category: 'Tombstone Maker', description: 'Granite headstones and memorials, crafted and engraved in Bulawayo.' },
    { name: 'Msasa Florists', category: 'Florist', description: 'Wreaths and grave flowers, Bulawayo and surrounds.' },
