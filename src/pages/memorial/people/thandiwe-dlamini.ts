...
const data: MemorialData = {
  ...
  avatarInitial: 'T',
  heroImage: '/theme-protea.jpg',
  accent: 'amber',
  epitaph: 'A beloved mother remembered for tireless care for everyone she met.',
  familyMessage: 'A loving, faithful mother \u2014 the heart of our family.',
  biography: [
    'Thandiwe Dlamini was born in 1952 in Johannesburg, South Africa, into a close and hardworking family. From an early age she was known for tireless care for everyone she met, qualities that would come to define her whole life.',
    'She spent many years as a nurse, earning the respect of everyone she worked alongside. Yet it was at home, surrounded by family, that she was truly happiest.',
    ...
    'A respected member of the Johannesburg community, she touched countless lives through her gentle spirit and generous heart. Neighbours remember her as someone who gave freely and asked for little in return.',
  ...
  timeline: [
    { date: '1952', title: 'Born in Johannesburg', body: 'Thandiwe Dlamini was born in 1952 in Johannesburg, South Africa.' },
    { date: '1974', title: 'Built a Life and Family', body: 'She married and began raising a family, working as a nurse.' },
    { date: '1997', title: 'A Pillar of the Community', body: 'Known across Johannesburg for tireless care for everyone she met, she became a trusted and beloved figure.' },
    { date: '2025', title: 'Passed Away', body: 'Thandiwe Dlamini passed away in 2025, deeply mourned and dearly loved.' },
  ],
  family: [
  ...
  guestbook: [
    ...
    { author: 'Sarah Dube', date: '2025', message: 'I will always remember her warmth and wisdom. Deepest condolences to the whole family.' },
  ],
  candles: 201,
  providers: [
