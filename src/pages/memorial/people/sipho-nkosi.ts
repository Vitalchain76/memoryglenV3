...
const data: MemorialData = {
  ...
  gallery: [
    { src: '/sipho-life-1.jpg', caption: 'A gathering of family, everyone together' },
    { src: '/sipho-life-2.jpg', caption: 'A quiet morning at home' },
    { src: '/sipho-life-3.jpg', caption: 'Celebrating a milestone with loved ones' },
    { src: '/sipho-life-4.jpg', caption: 'Sunday best, ready for church' },
    { src: '/sipho-life-5.jpg', caption: 'Among friends and neighbours' },
    { src: '/sipho-life-6.jpg', caption: 'A treasured everyday moment' },
  ],
  ...
  candles: 132,
  providers: [
    { name: 'Eternal Stone Tombstones', category: 'Tombstone Maker', description: 'Granite headstones and memorials, crafted and engraved in Durban.' },
    { name: 'Msasa Florists', category: 'Florist', description: 'Wreaths and grave flowers, Durban and surrounds.' },
