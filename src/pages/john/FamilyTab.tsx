...
import { CHILDREN, GRANDCHILDREN } from '@/pages/john/data';
import type { FamilyMember } from '@/pages/john/data';
...
/** TAB: Family - his children and grandchildren. */
export default function FamilyTab() {
  return (
    <div>
      <Reveal>
        <p className="eyebrow">The heart of our family</p>
        <h2 className="type-h2 mt-4 text-body">His Family</h2>
        <p className="mt-3 max-w-reading leading-relaxed text-soft">
          Three children and six grandchildren - the family he raised, guided, and loved across continents.
        </p>
      </Reveal>

      <SectionDivider label="His Children" />
      ...
      <SectionDivider label="His Grandchildren" />
      <ul className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
