...
import Lightbox from '@/pages/john/Lightbox';
import PlaylistCard from '@/components/PlaylistCard';
import QRShareBlock from '@/components/QRShareBlock';
import Reveal from '@/components/Reveal';
import StatBand from '@/components/StatBand';
import Timeline from '@/components/Timeline';
import MemorialGallery from '@/pages/john/MemorialGallery';
import {
  AVATAR_INITIAL,
  BIOGRAPHY,
  BOOKLETS,
  ...
  TRIBUTES,
  VOICE_NOTE,
} from '@/pages/john/data';

/** TAB: Overview (default) - mirrors the founding memorial's Overview. */
export default function OverviewTab() {
  ...
  return (
    <div className="space-y-16 md:space-y-24">
      {/* 1 - Biography */}
      <section aria-labelledby="his-life">
        <Reveal>
          <p className="eyebrow">Biography</p>
          <h2 id="his-life" className="type-h2 mt-4 text-body">
            His Life
          </h2>
        </Reveal>
      ...
      <section aria-labelledby="tributes">
        <Reveal>
          ...
          <h2 id="tributes" className="type-h2 mt-4 text-body">
            Tributes from His Children and Family
          </h2>
        </Reveal>
      ...
      {/* 4 - Hymn */}
      <Reveal as="section" aria-label="A hymn he loved">
        <div className="card-raised flex flex-col gap-6 p-6 sm:flex-row sm:items-center sm:p-8">
          ...
          />
          <div>
            <p className="eyebrow">A Hymn He Loved</p>
      ...
      {/* 6 - Songs */}
      <section aria-labelledby="his-songs">
        <Reveal>
          <div className="card-well mb-6 p-6 sm:p-8">
            <p className="eyebrow">His Favourite Song</p>
            <p className="mt-4 max-w-reading leading-relaxed text-soft">
              This was one of John's favourite songs - a melody that filled his home and heart with
              joy. It plays at family gatherings still, and every note brings him close.
            </p>
            <a
          ...
          <PlaylistCard
            ...
            spotifyTracks={[
              {
                ...
                artist: 'Spotify · the hymns he sang',
                thumbnail: '/virginia-gallery-4.jpg',
              },
            ]}
            uploadedTracks={[
            ...
            onAddSong={() => {
              window.location.href = 'mailto:admin@memoryglen.com?subject=Add%20a%20song%20for%20John';
            }}
          />
        </Reveal>
      </section>
      ...
      <Reveal as="section" aria-label="Voice note">
        <div>
          <p className="eyebrow">His Voice</p>
          ...
          <AudioPlayer title={VOICE_NOTE.title} durationSeconds={42} avatarInitial={AVATAR_INITIAL} className="mt-6" />
        </div>
      </Reveal>
      ...
      <section aria-labelledby="resting-place">
            ...
            {RESTING_PLACE.photos.map((src, i) => (
              <li key={src}>
                ...
                >
                  <img
                    src={src}
                    alt={i === 0 ? 'The gravesite at Glen Forest Memorial Park' : 'Flowers laid on his grave'}
                    loading="lazy"
        ...
        <Reveal delay={0.15}>
          <div className="mt-8">
            <p className="eyebrow mb-4">A Plaque for His Resting Place</p>
            <QRShareBlock
              qrSrc={QR_SRC}
              url={MEMORIAL_URL}
              extended
              title="Order a brass QR plaque for his resting place"
            />
          </div>
        </Reveal>
        <Lightbox
