...
/**
 * Memorial hero for John Peters (demo) - mirrors the founding memorial's hero
 * exactly, reading identity from john/data so the layout stays generic.
 */
    ...
    <section className="bg-forest pb-16 pt-12 text-center text-bone md:pb-20 md:pt-16">
      <div className="container-content flex flex-col items-center">
        ...
        <motion.div
          ...
          className="mt-10"
        >
          <StatBand onDark stats={HERO_STATS} />
        </motion.div>
