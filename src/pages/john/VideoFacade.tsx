...
import type { ServiceVideo } from '@/pages/john/data';
import { VIDEOS_META } from '@/pages/john/data';

/** VideoFacade - 16:9 click-to-play facade over a service still. Never autoplays. */
