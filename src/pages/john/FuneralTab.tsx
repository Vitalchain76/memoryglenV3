...
import VideoFacade from '@/pages/john/VideoFacade';
import { FUNERAL_EVENT, SERVICE_VIDEOS } from '@/pages/john/data';

/** TAB: Funeral - "Funeral & Memorial Events". */
export default function FuneralTab() {
  return (
    <div>
      <Reveal>
        <p className="eyebrow">In his honour</p>
      ...
      <Reveal delay={0.1}>
        ...
        <p className="mt-3 max-w-reading leading-relaxed text-soft">
          ...
          attend may still witness and remember the day we honoured his life.
        </p>
