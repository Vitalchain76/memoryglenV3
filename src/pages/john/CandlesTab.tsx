...
import { CANDLES, NAME } from '@/pages/john/data';

/** TAB: Digital Candles - candle field, LightACandle ritual, dated list. */
export default function CandlesTab() {
  ...
  return (
    <div className="max-w-reading">
      <Reveal>
        <p className="eyebrow">In his memory</p>
      ...
      <Reveal delay={0.05}>
        <div
          ...
          aria-label={`${candles.length} candles burning for ${NAME}`}
        >
          <style>{`
